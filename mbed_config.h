...
#define MBED_CONF_APP_MAIN_STACK_SIZE                                         4096                                                                                               // set by application[DISCO_L072CZ_LRWAN1]
...
#define MBED_CONF_LORA_APPSKEY                                                { 0xBE, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } // set by application[*]
...
#define MBED_CONF_LORA_DEVICE_ADDRESS                                          0xBEE00000                                                                                        // set by application[*]
#define MBED_CONF_LORA_DEVICE_EUI                                             { 0xBE, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }                                                 // set by application[*]
#define MBED_CONF_LORA_DOWNLINK_PREAMBLE_LENGTH                               5                                                                                                  // set by library:lora
#define MBED_CONF_LORA_DUTY_CYCLE_ON                                          0                                                                                                  // set by application[*]
...
#define MBED_CONF_LORA_NWKSKEY                                                { 0xBE, 0xE0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } // set by application[*]
